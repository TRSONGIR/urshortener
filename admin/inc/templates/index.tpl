...
<head> 
	<meta charset="utf-8" /> 
	<title>Metro Shrink | Dashboard</title>
...
<body>
    ...
    <header>
        ...
        <div class="logged"><p>Welcome, <span><?php echo $config['username']; ?></span> | <a href="logout.php">Logout</a></p></div>
			...
			<footer>
				<p><?php echo $config['site_name'] . ' ' . METROSHRINK_VERSION; ?> -Download From <a href="http://persianscript.ir">PersianScript (TM) </a> -- All Rights Reserved </span></p>
			</footer><!-- end footer-->
